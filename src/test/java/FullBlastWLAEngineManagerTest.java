...
public class FullBlastWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FullBlastWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/FullBlastWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/FullBlastWLAIW/InitOutcome.xml").getDocumentElement();
